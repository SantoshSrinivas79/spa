<!--suppress ALL -->
<template>
    <div class="loanRepayment-report">
        <a4>
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                this.$refs["loanRepayment-report"].validate((valid) => {
                    if (valid) {
                        Meteor.call('loanRepaymentReport', this.params, this.langConfig, (err, result) => {
                            if (result) {
                                this.repaymentHtml = result.repaymentHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['repayment'];
                return data;
            }
        },
        components: {

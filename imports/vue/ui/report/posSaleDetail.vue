<!--suppress ALL -->
<template>
    <div class="posSaleDetail-report">
        <a4>
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posSaleDetailReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['saleDetail'];
                return data;
            }
        },
        components: {
